...
//         params,
//         // Belt-and-suspenders: even with the server sending no-store,
//         // make sure axios/the browser never serves a cached copy of
...
//             {college.location}{college.affiliation ? ` · ${college.affiliation}` : ''}
//           </p>
//         </header>
//         <FilterBar
//           filters={filters}
//           onChange={(filter, value) => setFilters(previous => ({ ...previous, [filter]: value }))}
//         />
  ...
  return (
    <main className="min-h-screen bg-[#f4f8fd] px-4 py-6 sm:py-8">
      <div className="mx-auto max-w-4xl">
        ...
        <h1 className="mb-1 text-3xl font-extrabold leading-tight text-slate-900 sm:text-4xl">
          Make the <span className="text-[#2475aa]">Right Choice</span> with
        </h1>
        <h1 className="mb-5 text-3xl font-extrabold leading-tight text-[#D3540D] sm:text-4xl">
          Senior Suggestions
        </h1>
